...
if(!isset($_POST['submit'])){   
    ...
    $article = $client->executeQuery("proiect.bauturi", $query);
        ...
        <header class="bg-dark py-5">
            <div class="container px-4 px-lg-5 my-5">
                ...
                <div class="text-center text-white">
                    ...
                    Nume bautura:<input class="form-control" style="width: 30%; margin-left: auto; margin-right: auto;" type="text" name="nume" value="<?php echo $doc->nume;?>" readonly><br/>
                    Imagine:<br/>
                    <img style="width:200px; height:200px;" src="<?php echo $doc->imagine;?>"><br/>
                    Ingrediente:<input class="form-control" style="width: 30%; margin-left: auto; margin-right: auto;" type="text" name="ingrediente" value="<?php echo $doc->ingrediente;?>" readonly><br/>
                    Tipul bauturii:<input class="form-control" style="width: 30%; margin-left: auto; margin-right: auto;" type="text" name="tipbautura" value="<?php echo $doc->tip_bautura;?>" readonly><br/>
                    Pret:<input class="form-control" style="width: 30%; margin-left: auto; margin-right: auto;" type="text" name="pret" value="<?php echo $doc->pret;?>" readonly><br/>
