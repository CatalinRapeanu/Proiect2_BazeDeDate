...
<html lang="en">
    ...
    <body>
        ...
        $rows = $client->executeQuery("proiect.bauturi", $query);

        $nr = 0;//iterator_count(iterator_to_array($rows));
        foreach($rows as $row){
            $nr++;
        } 
        $nr2 = 0;
        ...
        echo "<td>" . $row->pret . "</td>";
        echo "<td><a href=\"editimage.php?id=".$row->_id."\">Editati</a>
        <a href=\"view.php?id=".$row->_id."\">Vizualizati</a>
        <a href=\"deleteimage.php?id=".$row->_id."\">Stergeti</a></td>";
        $nr2++;
        if($nr%2==1){
        if($nr2==(int)($nr/2)+1)
            echo "<td><a href=\"upload.php?id=".$row->_id."\">Incarcati</a></td>";
        else
            echo "<td></td>";
        }
        else{
        ...
        if($nr==0){
            ...
            if (!empty($row->_id)) {
                ...
                echo "<td><a href=\"upload.php\">Incarcati</a></td>";
            }
        }
        echo "</tr>";
        echo "</table>";
