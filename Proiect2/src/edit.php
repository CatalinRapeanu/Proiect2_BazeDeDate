...
if(!isset($_POST["submit"])){ 
    ...
    $article = $client->executeQuery("proiect.conturi", $query);
        ...
        <header class="bg-dark py-5">
            <div class="container px-4 px-lg-5 my-5">
                ...
                <div class="text-center text-white">
                    ...
                    Utilizator:<input class="form-control" style="width: 50%; margin-left: auto; margin-right: auto;" type="text" name="username" value="<?php echo $doc->username; ?>"><br>
                    Parola:<input class="form-control" style="width: 50%; margin-left: auto; margin-right: auto;" type="text" name="password" value="<?php echo $doc->password; ?>"><br>
                    Tipul de utilizator: <br> <input class="form-control" style="width: 50%; margin-left: auto; margin-right: auto;" type="text" name="usertype" value="<?php echo $doc->user_type; ?>"><br>
